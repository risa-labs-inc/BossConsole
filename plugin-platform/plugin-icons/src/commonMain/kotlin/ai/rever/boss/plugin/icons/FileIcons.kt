...
object FileIcons {
    ...
    private fun forSpecialFileName(fileName: String): FileIconInfo? {
        ...
        return when {
            ...
            lowerName == "package.json" -> {
                FileIconInfo(LanguageIcons.npm, LanguageIcons.Colors.npm)
            }
            ...
            lowerName == "yarn.lock" -> {
                FileIconInfo(LanguageIcons.yarn, LanguageIcons.Colors.yarn)
            }

            lowerName == "pnpm-lock.yaml" -> {
                FileIconInfo(LanguageIcons.pnpm, LanguageIcons.Colors.pnpm)
            }
            ...
            lowerName == "pom.xml" -> {
                FileIconInfo(LanguageIcons.maven, LanguageIcons.Colors.maven)
            }
     ...
     */
    private fun Pair<ImageVector, Color>.toFileIconInfo(): FileIconInfo = FileIconInfo(first, second)
}
