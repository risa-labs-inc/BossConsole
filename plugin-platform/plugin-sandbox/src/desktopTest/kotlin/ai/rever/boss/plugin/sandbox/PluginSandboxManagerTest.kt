...
class PluginSandboxManagerTest {
    ...
    @BeforeEach
    fun setUp() {
        manager = PluginSandboxManagerImpl(
    ...
    inner class SandboxRemovalTests {
        ...
        @Test
        fun `removeSandbox removes sandbox`() = runTest {
            manager.createSandbox("plugin-1")
        ...
        @Test
        fun `removeSandbox is safe for unknown plugin`() = runTest {
            // Should not throw
    ...
    inner class RestartTests {
        ...
        @Test
        fun `restartPlugin returns failure for unknown plugin`() = runTest {
        ...
        @Test
        fun `restartPlugin returns success for known plugin`() = runTest {
            val sandbox = manager.createSandbox("plugin-1")
            sandbox.start()
    ...
    inner class DisableEnableTests {
        ...
        @Test
        fun `disablePlugin marks plugin as disabled`() = runTest {
            manager.createSandbox("plugin-1")
        ...
        @Test
        fun `enablePlugin removes plugin from disabled set`() = runTest {
            manager.createSandbox("plugin-1")
            manager.disablePlugin("plugin-1")
        ...
        @Test
        fun `getDisabledPlugins returns all disabled plugins`() = runTest {
            manager.createSandbox("plugin-1")
            manager.createSandbox("plugin-2")
            manager.createSandbox("plugin-3")
        ...
        @Test
        fun `disablePlugin sets sandbox state to DISABLED`() = runTest {
            val sandbox = manager.createSandbox("plugin-1")
            sandbox.start()
    ...
    inner class ListenerTests {
        ...
        @Test
        fun `listener receives onPluginRestarting event`() = runTest {
        ...
        @Test
        fun `listener receives onPluginRestarted event`() = runTest {
            var receivedPluginId: String? = null
            val listener = object : PluginSandboxListener {
        ...
        @Test
        fun `listener receives onPluginDisabled event`() = runTest {
            var receivedPluginId: String? = null
            val listener = object : PluginSandboxListener {
        ...
        @Test
        fun `removeListener stops receiving events`() = runTest {
            var callCount = 0
            val listener = object : PluginSandboxListener {
                override fun onPluginDisabled(pluginId: String) {
                    callCount++
    ...
    inner class DisposeTests {
        ...
        @Test
        fun `dispose clears all sandboxes`() = runTest {
            manager.createSandbox("plugin-1")
            manager.createSandbox("plugin-2")
