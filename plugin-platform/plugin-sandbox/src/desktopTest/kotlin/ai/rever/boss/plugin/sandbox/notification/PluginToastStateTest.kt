...
class PluginToastStateTest {
    ...
    inner class ShowTests {
        ...
        @Test
        fun `show respects maxToasts limit`() =
            testScope.runTest {
                repeat(5) { i ->
                    toastState.show(
                        ToastMessage(
        ...
        @Test
        fun `SHORT duration auto-dismisses after 3 seconds`() =
            testScope.runTest {
                toastState.show(
                    ToastMessage(
                        type = ToastType.INFO,
        ...
        @Test
        fun `LONG duration auto-dismisses after 6 seconds`() =
            testScope.runTest {
                toastState.show(
                    ToastMessage(
        ...
        @Test
        fun `INDEFINITE duration does not auto-dismiss`() =
            testScope.runTest {
                toastState.show(
                    ToastMessage(
    ...
    inner class DismissTests {
        @Test
        fun `dismiss removes specific toast by id`() =
            testScope.runTest {
                val message1 =
                    ToastMessage(
                        id = "toast-1",
        ...
        @Test
        fun `dismiss is safe for unknown id`() =
            testScope.runTest {
                toastState.show(
                    ToastMessage(
                        type = ToastType.INFO,
        ...
        @Test
        fun `dismiss cancels auto-dismiss timer`() =
            testScope.runTest {
                val message =
                    ToastMessage(
                        id = "toast-1",
        ...
        @Test
        fun `dismissAll clears all toasts`() =
            testScope.runTest {
                repeat(3) { i ->
                    toastState.show(
                        ToastMessage(
    ...
    inner class UtilityTests {
        @Test
        fun `hasToasts returns true when toasts exist`() =
            testScope.runTest {
        ...
        @Test
        fun `toastCount returns correct count`() =
            testScope.runTest {
