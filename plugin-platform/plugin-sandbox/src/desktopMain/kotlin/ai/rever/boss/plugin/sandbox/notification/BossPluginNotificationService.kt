...
class BossPluginNotificationService(
    ...
    override fun notifyPluginError(
        pluginId: String,
        error: Throwable,
    ) {
        logger.warn(
            LogCategory.SYSTEM,
            "Notifying plugin error",
            mapOf(
    ...
    override fun notifyPluginRestarting(
        pluginId: String,
        attempt: Int,
    ) {
        logger.info(
            LogCategory.SYSTEM,
            "Notifying plugin restarting",
            mapOf(
                "pluginId" to pluginId,
                "attempt" to attempt,
            ),
    ...
    override fun notifyPluginRestartSuccess(pluginId: String) {
        logger.info(
            LogCategory.SYSTEM,
            "Notifying plugin restart success",
            mapOf(
                "pluginId" to pluginId,
            ),
        )
    ...
    override fun notifyPluginRestartFailed(
        pluginId: String,
        error: Throwable,
    ) {
        logger.error(
            LogCategory.SYSTEM,
            "Notifying plugin restart failed",
            mapOf(
                "pluginId" to pluginId,
            ),
            error,
     ...
     */
    fun notifyPluginUnhealthy(
        pluginId: String,
        consecutiveErrors: Int,
    ) {
        logger.warn(
            LogCategory.SYSTEM,
            "Notifying plugin unhealthy",
            mapOf(
                "pluginId" to pluginId,
