...
class SandboxedPluginContext(
    ...
    override fun unregisterPanelMenuContribution(contributionId: String) = delegate.unregisterPanelMenuContribution(contributionId)

    override fun registerSettingsPage(provider: ai.rever.boss.plugin.api.SettingsPageProvider) = delegate.registerSettingsPage(provider)

    override fun unregisterSettingsPage(pageId: String) = delegate.unregisterSettingsPage(pageId)
    ...
    override fun unregisterDeepLinkActionHandler(handlerId: String) = delegate.unregisterDeepLinkActionHandler(handlerId)
    ...
    override fun unregisterShortcutActionProvider(providerId: String) = delegate.unregisterShortcutActionProvider(providerId)
