...
data class PluginHealthMetrics(
     ...
     */
    fun withHeartbeat(): PluginHealthMetrics = copy(
     ...
     */
    fun withError(): PluginHealthMetrics = copy(
     ...
     */
    fun withSuccess(): PluginHealthMetrics = copy(
        consecutiveErrors = 0
    )
     ...
     */
    fun withCrash(): PluginHealthMetrics = copy(
     ...
     */
    fun withSuccessfulRestart(): PluginHealthMetrics = copy(
        consecutiveErrors = 0,
        restartAttempts = 0,
        lastHeartbeat = System.currentTimeMillis()
    )
