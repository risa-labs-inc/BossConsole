...
/** Clean light theme. */
val BossLightColorScheme = BossColorScheme(
...
val BossCleanColorScheme = BossColorScheme(
...
private fun darkMaterial(s: BossColorScheme): Colors = darkColors(
    primary = s.signal,
...
private fun lightMaterial(s: BossColorScheme): Colors = lightColors(
    primary = s.signal,
    primaryVariant = s.signalDim,
    secondary = s.data,
    secondaryVariant = s.data,
