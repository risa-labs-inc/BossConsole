...
class NotificationProviderProxy(
    ...
    private fun NotificationType.toProto(): ai.rever.boss.ipc.proto.services.NotificationType =
        when (this) {
    ...
    private fun NotificationDuration.toProto(): ai.rever.boss.ipc.proto.services.NotificationDuration =
        when (this) {
