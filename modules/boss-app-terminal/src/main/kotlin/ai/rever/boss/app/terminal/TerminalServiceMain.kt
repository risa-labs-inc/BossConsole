    ...
    val manifest = ProcessManifest.newBuilder()
        ...
        .addAllCapabilities(listOf(
            PluginCapability.newBuilder()
                ...
                .setInputSchemaJson("""{"type":"object","properties":{"command":{"type":"string"},"workingDirectory":{"type":"string"}}}""")
                .setOutputSchemaJson("""{"type":"object","properties":{"exitCode":{"type":"integer"},"sessionId":{"type":"string"}}}""")
