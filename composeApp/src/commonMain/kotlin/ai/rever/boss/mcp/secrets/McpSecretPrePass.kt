...
internal sealed interface SecretPreparation {
    ...
    class Ready(
        ...
        /**
         * Rebuilt through [parseArgs] from the substituted tree, so the scalar map and the
         * raw JSON a handler might parse itself cannot disagree (INV6).
         */
        override fun executionArgs(original: McpToolArgs): McpToolArgs {
            ...
            return parseMcpToolArgs(McpArgumentSubstitution.encode(substituted))
        }
