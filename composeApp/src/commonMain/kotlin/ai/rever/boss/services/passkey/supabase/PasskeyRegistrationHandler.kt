...
internal object PasskeyRegistrationHandler {
    ...
    suspend fun requestChallenge(
        ...
        try {
            ...
            val parsedChallenge =
                PasskeyDataMapper.parsePasskeyChallenge(
    ...
    suspend fun completeRegistration(
        ...
        try {
            ...
            val registrationData =
                PasskeyDataMapper.createRegistrationData(
                    userId = userId,
     ...
     */
    fun validateAuthenticatorSelection(authenticatorSelection: AuthenticatorSelectionCriteria?): Result<Unit> {
