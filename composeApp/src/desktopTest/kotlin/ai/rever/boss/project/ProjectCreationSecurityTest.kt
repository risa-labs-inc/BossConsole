...
class ProjectCreationSecurityTest {
    ...
    @Test
    fun `test path traversal in project name is rejected`() = runBlocking {
    ...
    @Test
    fun `test legitimate template paths are accepted`() = runBlocking {
    ...
    @Test
    fun `test created files do not escape project directory`() = runBlocking {
    ...
    @Test
    fun `test special shell characters in project name are safe`() = runBlocking {
    ...
    @Test
    fun `test project creation does not follow symlinks outside directory`() = runBlocking {
    ...
    @Test
    fun `test validation and creation are consistent`() = runBlocking {
    ...
    @Test
    fun `test rejected names cannot be created`() = runBlocking {
