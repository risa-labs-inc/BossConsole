...
class ProjectCreationIntegrationTest {
    ...
    @Test
    fun `test create empty project successfully`() = runBlocking {
    ...
    @Test
    fun `test empty project README contains project name`() = runBlocking {
    ...
    @Test
    fun `test create Kotlin JVM project successfully`() = runBlocking {
    ...
    @Test
    fun `test Kotlin project placeholder substitution`() = runBlocking {
    ...
    @Test
    fun `test create Node js project successfully`() = runBlocking {
    ...
    @Test
    fun `test Node js package json contains package name`() = runBlocking {
    ...
    @Test
    fun `test create Go project successfully`() = runBlocking {
    ...
    @Test
    fun `test create Rust project successfully`() = runBlocking {
    ...
    @Test
    fun `test Rust Cargo toml contains package name`() = runBlocking {
    ...
    @Test
    fun `test create Python project successfully`() = runBlocking {
    ...
    @Test
    fun `test create project with invalid name fails`() = runBlocking {
        val result = ProjectCreationService.createProject(
            name = "",
            parentDirectory = tempDir.absolutePath,
            template = ProjectTemplate.Empty,
    ...
    @Test
    fun `test create project in non-existent directory fails`() = runBlocking {
        val result = ProjectCreationService.createProject(
            name = "test-project",
    ...
    @Test
    fun `test create project where directory already exists fails`() = runBlocking {
    ...
    @Test
    fun `test create project with Windows reserved name fails`() = runBlocking {
        val result = ProjectCreationService.createProject(
            name = "CON",
            parentDirectory = tempDir.absolutePath,
            template = ProjectTemplate.Empty,
    ...
    @Test
    fun `test concurrent creation with same name handled correctly`() = runBlocking {
        val projectName = "concurrent-test"

        // First creation should succeed
        val result1 = ProjectCreationService.createProject(
            name = projectName,
            parentDirectory = tempDir.absolutePath,
            template = ProjectTemplate.Empty,
            onProgress = { _, _ -> }
        ...
        val result2 = ProjectCreationService.createProject(
            name = projectName,
            parentDirectory = tempDir.absolutePath,
            template = ProjectTemplate.Empty,
            onProgress = { _, _ -> }
    ...
    @Test
    fun `test progress callback is called with increasing values`() = runBlocking {
    ...
    @Test
    fun `test failed creation cleans up partial directory`() = runBlocking {
    ...
    @Test
    fun `test project name with leading and trailing spaces is trimmed`() = runBlocking {
