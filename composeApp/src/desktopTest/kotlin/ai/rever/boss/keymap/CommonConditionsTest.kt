...
class CommonConditionsTest {
    ...
    @Test
    fun `ConditionBuilder creates enabled condition when check returns true`() =
        runBlocking {
            val condition =
                ConditionBuilder()
                    .whenTrueSync { true }
    ...
    @Test
    fun `ConditionBuilder creates disabled condition when check returns false`() =
        runBlocking {
            val condition =
                ConditionBuilder()
                    .whenTrueSync { false }
    ...
    @Test
    fun `ConditionBuilder with async check works`() =
        runBlocking {
            var called = false
            val condition =
                ConditionBuilder()
    ...
    @Test
    fun `condition DSL creates working condition`() =
        runBlocking {
            val flag = true
            val cond =
                condition {
    ...
    @Test
    fun `enabledWhen creates working condition`() =
        runBlocking {
            val cond =
                enabledWhen(
                    reason = "Not ready",
    ...
    @Test
    fun `enabledWhenSync creates working condition`() =
        runBlocking {
            var counter = 0
            val cond =
                enabledWhenSync(
    ...
    @Test
    fun `and combinator requires both conditions`() =
        runBlocking {
    ...
    @Test
    fun `or combinator requires at least one condition`() =
        runBlocking {
            val trueCondition = enabledWhenSync { true }
            val falseCondition = enabledWhenSync { false }
    ...
    @Test
    fun `not combinator inverts condition`() =
        runBlocking {
            val trueCondition = enabledWhenSync { true }
            val falseCondition = enabledWhenSync { false }
    ...
    @Test
    fun `not combinator uses custom reason and description`() =
        runBlocking {
            val cond =
                enabledWhenSync { true }.not(
    ...
    @Test
    fun `complex combinator chain works`() =
        runBlocking {
    ...
    @Test
    fun `Conditions hasTabs works correctly`() =
        runBlocking {
            var tabCount = 0
    ...
    @Test
    fun `Conditions hasMinTabs works correctly`() =
        runBlocking {
            var tabCount = 0
    ...
    @Test
    fun `Conditions hasMultipleTabs works correctly`() =
        runBlocking {
            var tabCount = 0
    ...
    @Test
    fun `Conditions hasActiveTab works correctly`() =
        runBlocking {
            var hasActive = false
    ...
    @Test
    fun `Conditions canNavigateSplits works correctly`() =
        runBlocking {
            var splitCount = 1
    ...
    @Test
    fun `Conditions canCreateSplit works correctly`() =
        runBlocking {
            var splitCount = 1
    ...
    @Test
    fun `Conditions hasClipboardContent works correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions hasSelection works correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions isEditable works correctly`() =
        runBlocking {
            var editable = false
    ...
    @Test
    fun `Conditions canUndo and canRedo work correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions always and never work correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions debugOnly works correctly`() =
        runBlocking {
            var isDebug = false
    ...
    @Test
    fun `Conditions featureFlag works correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions context checks work correctly`() =
        runBlocking {
    ...
    @Test
    fun `Conditions navigation checks work correctly`() =
        runBlocking {
    ...
    @Test
    fun `Real-world scenario - paste enabled when clipboard has content and editor is active`() =
        runBlocking {
            var hasClipboard = false
            var isEditorActive = false

            val pasteCondition =
                Conditions.hasClipboardContent { hasClipboard } and
    ...
    @Test
    fun `Real-world scenario - close tab enabled with tabs OR can create split`() =
        runBlocking {
            var tabCount = 0
            var splitCount = 4
            ...
            val condition =
                Conditions.hasTabs { tabCount } or
