 ...
 */
actual fun createNotificationProvider(toastController: ToastController): NotificationProvider = NotificationProviderImpl(toastController)
...
class NotificationProviderImpl(
    ...
    private fun NotificationType.toToastType(): ToastType =
        when (this) {
    ...
    private fun NotificationDuration.toToastDuration(): ToastDuration =
        when (this) {
