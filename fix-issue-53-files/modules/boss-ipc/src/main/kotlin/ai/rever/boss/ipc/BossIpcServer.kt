...
class BossIpcServer(
    ...
    /**
     * Applied to every service on this server, build-time or late-registered alike.
     *
     * Empty by default, so adding this parameter changes nothing for a caller that does not pass one.
     * The kernel's own instance is the only caller that does today - see
     * [ai.rever.boss.ipc.auth.ProcessAuthServerInterceptor].
     */
