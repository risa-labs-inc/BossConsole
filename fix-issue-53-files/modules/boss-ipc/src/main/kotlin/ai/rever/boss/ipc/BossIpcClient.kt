...
class BossIpcClient(
    ...
    /**
     * Applied to every call made on this channel.
     *
     * Empty by default, so adding this parameter changes nothing for a caller that does not pass one. A
     * child process's channel to the kernel is the only caller that does today - see
     * [ai.rever.boss.ipc.auth.ProcessAuthClientInterceptor].
     */
