...
- [Agent coordination](docs/AGENT_COORDINATION.md) - the `agent_*` MCP tools: a shared advisory board where agents declare what they are working on and see file overlap with other agents in the same BOSS
